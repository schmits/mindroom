...
- [Matrix & Attachments](https://docs.mindroom.chat/tools/matrix-and-attachments/) - Matrix-native messaging and voice messages, thread tags, summaries, and model overrides, low-level Matrix API access, and attachment-aware workflows.
